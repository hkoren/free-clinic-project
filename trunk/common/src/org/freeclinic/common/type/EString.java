...
public class EString extends Extra<String> implements JSONSerializable {
	...
	public void unmarshallJSON(JSONObject json) throws JSONException {
		...
		set(json.getString(NUGGET));
	}

	public EString(String nug) {
		super(nug);
	}
	public EString(JSONObject json) throws JSONException {
		super(json);
