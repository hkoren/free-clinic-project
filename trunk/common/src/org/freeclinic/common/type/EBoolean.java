...
public class EBoolean extends Extra<Boolean> implements JSONSerializable {
	...
	public void unmarshallJSON(JSONObject json) throws JSONException {
		...
		set(json.getBoolean(NUGGET));
	}

	public EBoolean(Boolean nug) {
		super(nug);
	}
	public EBoolean(JSONObject json) throws JSONException {
		super(json);
