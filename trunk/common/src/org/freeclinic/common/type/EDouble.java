...
public class EDouble extends Extra<Double> implements JSONSerializable {
	...
	public void unmarshallJSON(JSONObject json) throws JSONException {
		...
		set(json.getDouble(NUGGET));
	}

	public EDouble(Double nug) {
		super(nug);
	}
	public EDouble(JSONObject json) throws JSONException {
		super(json);
