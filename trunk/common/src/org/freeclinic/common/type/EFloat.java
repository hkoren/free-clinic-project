...
public class EFloat extends Extra<Float> implements JSONSerializable {
	...
	public void unmarshallJSON(JSONObject json) throws JSONException {
		...
		set((float)json.getDouble(NUGGET));
	}

	public EFloat(Float nug) {
		super(nug);
	}
	public EFloat(JSONObject json) throws JSONException {
		super(json);
