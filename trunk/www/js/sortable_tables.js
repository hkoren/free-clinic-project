...
update(SortableManager.prototype, {
    ...
    "initWithTable": function (table,head,body) {
        /***
        ...
        ***/
        ...
        // Find the thead
        this.thead = table.getElementsByTagName(head)[0];
        ...
        this.tbody = table.getElementsByTagName(body)[0];
        // every row
...
sortableManager1 = new SortableManager();
sortableManager2 = new SortableManager();

addLoadEvent(function () {
	if ($('sortable_table')) {
	    sortableManager1.initWithTable('sortable_table','thead','tbody',1);
	}
	if ($('sortable_measurement')) {
		sortableManager2.initWithTable('sortable_measurement','thead','tbody',2);
	}
});
